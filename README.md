...
* Accorss any edge $e = \{x,y\}\in E$, we independtely flip the signal with probability 
$$
...
then
$$
\mathbb{P}_{\boldsymbol{\theta}^*}\left(\sigma_u Z_u^{\widehat{\boldsymbol{\theta}}} \ge 1-\frac{121}{5} \delta^2\right) \ge 1-\frac{7}{2}\delta
